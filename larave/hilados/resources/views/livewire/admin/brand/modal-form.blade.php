      ...
      <div class="modal-content ">
        ...
        <div class="modal-body">
            <div class="mb-3">
                ...
                <select class="border 2px bg-primary"   wire:model.defer="category_id" required class="form-control">
                    <option class="bg-primary " value="">--Select Categoria--</option>
                    @foreach ($categories as $cateItem )
                    <option class="border 2px" value="{{$cateItem->id}}">{{$cateItem->name}}</option>
                    @endforeach
                </select>
...
<div wire:ignore.self class="modal fade  " id="updatebrandModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content ">
        <div class="modal-header">
          <h1 class="modal-title fs-5 bg-primary text-center " id="exampleModalLabel">Editar Tipos</h1>
          <button type="button" class="btn-close" wire:click="closeModal" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="modal-footer">
                <button type="button" wire:click="closeModal" class="btn btn-primary float-end shadow p-3  " data-bs-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-primary float-end shadow p-3 ">Guardar Cambios</button>
            </div>
            </form>
